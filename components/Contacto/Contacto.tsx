          ...
          <div className="border border-masyp/10 bg-main-gray rounded-[10px] p-4 md:p-[50px]">
            ...
            >
              <input
                ...
                className="col-span-6 h-[30px] focus:outline-none border-b border-masyp/10 focus:border-masyp bg-transparent"
              />
              <input
                type="email"
                placeholder="Email"
              ...
              <div className="col-span-6 md:col-span-12">
                <button className="home-two-btn-bg py-3 group bg-[#034281] border-[#034281] inline-flex">

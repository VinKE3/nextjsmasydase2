      ...
      <div className="w-full mx-auto theme-container">
        <div className="max-w-[661px] w-full flex flex-col items-center mx-auto">
          ...
          <h2 className="pt-5 font-semibold text-center text-black text-24 sm:text-48">
            Servicios creativos para hacer crecer su negocio
          </h2>
        </div>
        <div className="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-x-4 md:gap-x-8 gap-y-[30px] mt-10 md:mt-[70px]">
          ...
          >
            ...
            <p className="text-paragraph mt-1.5">
              Utilizamos las últimas herramientas y frameworks para garantizar
          ...
          >
            ...
            <p className="text-paragraph mt-1.5">
              Soluciones hechas a medida según las necesidades y objetivos
          ...
          >
            ...
            <p className="text-paragraph mt-1.5">
              Medidas de seguridad como certificados SSL, protección contra
              ataques, y seguridad en el código para garantizar la integridad
              del sitio y la privacidad de los datos.
            </p>
          </div>
          {/* <!-- card end  --> */}
          {/* <!-- card start  --> */}
          ...
          >
            ...
            <p className="text-paragraph mt-1.5">
              Implementación de un sistema de gestión de contenidos (CMS) como
              WordPress o un CMS personalizado que permita al cliente actualizar
              fácilmente el contenido del sitio.
            </p>
          </div>
          {/* <!-- card end  --> */}
          {/* <!-- card start  --> */}
          ...
          >
            ...
            <p className="text-paragraph mt-1.5">
              El sitio web debe adaptarse a diferentes dispositivos y tamaños de
              pantalla (móviles, tabletas, ordenadores).
            </p>
          </div>
          {/* <!-- card end  --> */}
          {/* <!-- card start  --> */}
          ...
          >
            ...
            <p className="text-paragraph mt-1.5">
              Servicios de mantenimiento continuo para actualizaciones,
              correcciones de errores, o ajustes que el cliente pueda necesitar
              con el tiempo.
            </p>
          </div>
          {/* <!-- card end  --> */}

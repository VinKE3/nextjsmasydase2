  ...
  return (
    ...
    >
      <div className="relative w-full overflow-hidden bg-[#10100E] ">
        <img
          src="./assets/images/hero-bg1.png"
          alt=""
          className="absolute z-0 w-full h-full mx-auto "
        />
        <div className="w-full max-w-[1506px] theme-container mx-auto md:mt-20">
          <div className="grid grid-cols-6 xl:grid-cols-12 z-10 pt-[70px] lg:pt-[120px] lg:pb-[120px]">
            <div className="col-span-6 my-auto">
              ...
              <div className="flex flex-col gap-3 mt-5 sm:flex-row sm:gap-6 md:mt-12">
                <Link href="#servicios">
                  <div className="home-two-btn-white group before:bg-masyp after:bg-masyp border-masyp hover:border-white">
                    <span className="relative z-10 py-1 text-base font-semibold transition-all duration-300 group-hover:text-white text-white font-inter">
                      Ver Servicios
                    </span>
                    <svg
                ...
                <Link href="#contacto">
                  <div className="home-two-btn-white-rev group before:bg-masyp after:bg-masyp hover:border-masyp">
              ...
              <div className="flex gap-2.5 items-center mt-5 relative z-10">
                ...
                <p className="text-white">Satisfacción garantizada</p>
              </div>
            </div>
            <img
